import { ChevronFirst, ChevronLast, MoreVertical, Home, DollarSign, BookAIcon, User, BookMinus, User2, Pencil, Pen, PenIcon, PencilIcon } from "lucide-react";
...
const menuItems = [
  ...
  { label: "Authors", icon: PencilIcon, path: "/authors" },
